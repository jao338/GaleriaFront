<template>
  ...
  <div id="resetPassword" class="container">
    <div class="d-flex flex-column justify-content-center align-items-center h-100">
        ...
        <routerLink :to="{ name:'home' }" class="navbar-brand mB-32">

            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="fillColor" class="bi bi-github" viewBox="0 0 16 16">
